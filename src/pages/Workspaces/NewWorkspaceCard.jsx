    ...
    <>
      ...
      >
        <div className="card-body p-4 sm:p-5 flex flex-col justify-between">
          {/* Judul Workspace */}
          <h2 className="card-title text-black/90 truncate mb-3 text-lg font-bold">
            {workspace?.nama}
          </h2>

          {/* BARIS 1: Progress & Tombol Aksi */}
          <div className="flex items-center justify-between gap-3 mb-4 ">
            ...
            {/* Action Buttons */}
            <div className="card-actions flex items-center justify-end gap-1.5 shrink-0 self-end">
              {isAdmin && (
                <button
                  type="button"
                  className="btn btn-xs btn-error text-orange-950 font-semibold px-2.5"
                  onClick={(e) => {
                    e.stopPropagation();
              ...
              <button
                type="button"
                className="btn btn-xs  btn-primary px-3 font-semibold"
                onClick={(e) => {
                  e.stopPropagation();
          ...
          {/* BARIS 2: Member Avatar Stack (Di bagian bawah) */}
          <div
            className="relative z-20 pt-2 border-t border-black/5"
            ref={containerRef}
          >
                ...
                <div className="flex items-center flex-wrap">
                  {visibleMembers.map(
                    (member, index) =>
                      ...
                      pointer-events-none shadow-lg z-30"
                          >
                            {member.user.username}
                            <div
                  ...
                  {remainingCount > 0 && (
                    <button
                      ...
                      className="
                  w-9 h-9 rounded-full bg-gray-700
                  flex items-center justify-center text-white font-semibold text-xs
                  ring-2 ring-white shadow-md
                  transform transition-all duration-300 ease-out
                  hover:scale-110 hover:-translate-y-1 hover:bg-gray-600
                "

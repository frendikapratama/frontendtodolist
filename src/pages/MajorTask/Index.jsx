          ...
          <div className="w-[50vw] min-w-max">
            ...
            {displayTasks?.map((task) => (
              ...
              >
                ...
                >
                  <span className="text-[0.8em] text-gray-700 px-1 break-all line-clamp-10 flex-1 min-w-0">
                    {task.nama}
                  </span>
                </div>
                      ...
                      {task.pic.slice(0, 3).map((picUser, idx) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            {/* Tooltip */}
                            <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-2 py-1 bg-gray-900 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-all duration-200 pointer-events-none whitespace-nowrap z-[9999]">
